...
@push('js')
    ...
    <script src="{{ asset('assets/backend/libs/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('assets/backend/libs/demo/chart-pie-demo.js') }}"></script>
    <script src="{{ asset('assets/backend/libs/demo/chart-bar-demo.js') }}"></script>
