    ...
    <div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary"><a href="/" class="text-decoration-none">Manage Company</a> </h6>
                <button class="btn btn-sm btn-info" id="add"><i class="fa fa-plus"> Add Company Info</i></button>
            </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold modal-heading" id="exampleModalLabel">Add Company Info</h5>
                ...
                <div class="modal-body">
                    <div id="service-container">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="font-weight-bold bg-custom-booking">Company Information</h5>
                                <hr>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="white_logo">White Logo</label> <br>
