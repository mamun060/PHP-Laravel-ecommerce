    ...
    <div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary"><a href="/" class="text-decoration-none">Shop Banner Settings</a> </h6>
                <button class="btn btn-sm btn-info" id="add"><i class="fa fa-plus"> Banner</i></button>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            @isset($shopBanner)
                            {{-- @dd($shopBanner) --}}
                                @foreach ($shopBanner as $bannerItem)
                                    <tr data-banner="{{ json_encode($bannerItem)}}">
                                        <td>{{ $loop->iteration }}</td>
                                        <td>
                                            {{ $bannerItem->name }}
                                        </td>
                                        <td>
                                            @if($bannerItem->banner_image)
                                                <img src="{{ asset($bannerItem->banner_image) }}" style="width: 100px;" alt="Banner Image">
                                            @else 
                                                <img src="" style="width: 150px;" alt="Banner Image">
                                            @endif
                                        </td>
                                        <td class="text-center">
                                            {!! $bannerItem->is_active ? '<span class="badge badge-success">Active </span>' : '<span class="badge badge-danger">In-Active </span>' !!}
                                        </td>
                                        <td class="text-center">
                                            ...
                                            <a href="{{route('admin.shopbanner.destroy', $bannerItem->id )}}" class="fa fa-trash text-danger text-decoration-none delete"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endisset
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold modal-heading" id="exampleModalLabel"> <span class="heading">Create</span> Shop Banner</h5>
                ...
                <div class="modal-body">
                    <div id="service-container">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="font-weight-bold bg-custom-booking">Banner Info</h5>
                                <hr>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="" id="name" class="form-control" placeholder="Banner Title" />
                                </div>
                            </div>
    ...
    <script>
        ...
        function showUpdateModal(){
            ...
            if(shopBanner){
                ...
                $('#name').val(shopBanner?.name)
 
                if(shopBanner?.is_active){
                ...
                $(document).find('#img-preview').attr('src', `{{ asset('') }}${shopBanner.banner_image}`);
        ...
        ajaxFormToken();
            ...
            let obj = {
                url     : `{{ route('admin.shopbanner.update', '' ) }}/${id}`, 
                method  : "PUT",
                data    : formatData(),
            };
        ...
        function submitToDatabase(){
            ...
            ajaxFormToken();
                ...
                let obj = {
                    url     : `{{ route('admin.shopbanner.store')}}`, 
                    method  : "POST",
                    data    : formatData(),
                };
